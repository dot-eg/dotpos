...
class _LoginScreenPageState extends State<LoginScreenPage> {
  ...
  Future<void> _loginoffline() async {
    ...
    final errorMessage = _authService.loginoffline(_adminPasswordController.text, context);
    setState(() {
      _isLoading = false;
    });
    if (errorMessage != "") {
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<bool>(
        future: _offlineService.isConnected(),
              ...
              children: [
                ...
                Positioned(
                  ...
                  child: Container(
                    ...
                    child: TextFormField(
                      ...
                      onFieldSubmitted: (value) => _loginoffline(),
                ...
                Positioned(
                  ...
                  child: ElevatedButton(
                    onPressed: () async {
                      var isConnected = await OfflineService().isConnected();
                      if (isConnected) {
                        setState(() {});
                      }
                    },
