                            ...
                            showDialog(
                              ...
                              builder: (BuildContext context) {
                                return AlertDialog(
                                  ...
                                  content: Text('Are you sure you want to delete the selected user(s)?'),
                                  actions: <Widget>[
                                    TextButton(
                                      child: Text('Cancel'),
                                      onPressed: () {
                                    ...
                                    TextButton(
                                      ...
                                      onPressed: () {
                                        AlertDialog(
                                          title: Text('error'),
                                          content: Text('You cannot delete the current user.'),
                                          actions: <Widget>[
                                            TextButton(
                                              onPressed: () {
                                                Navigator.of(context).pop();
                      ...
                      child: SizedBox(
                        ...
                        child: ElevatedButton(
                          onPressed: () async {
                            ...
                            String result = await authService.resetPassword(user.email);
                            showDialog(
                              context: context,
                              builder: (BuildContext context) {
